...
let voltarBtn = document.getElementById("fechar");
...
const convertPokemonToHtml = pokemon => {
  ...
  <div class="modal-content ${pokemon.type}">
    <div>
        <span id="fechar" class="close" onclick="closeModal()">
        ↩
        </span>
    </div>
      ...
      <div id="About" class="tabcontent">
        ...
        <div id="Stats" class="tabcontent">
            <ol class="table tableStats">
                ...
                <li class="tableValue">
              ${pokemon.stats["attack"]} <progress class="stats" value="${pokemon.stats["attack"]}" max="100"></progress>
                </li>
                <li class="tableHeader">
                    Defense
                </li>
                <li class="tableValue">
              ${pokemon.stats["defense"]} <progress class="stats" value="${pokemon.stats["defense"]}" max="100"></progress>
                </li>
                <li class="tableHeader">
                    Special Attack
                </li>
                <li class="tableValue" class="tableValue">
              ${pokemon.stats["special-attack"]} <progress class="stats" value="${pokemon.stats["special-attack"]}" max="100"></progress>
                </li>
                <li class="tableHeader">
                    Spencial Defense
                </li>
                <li class="tableValue">
              ${pokemon.stats["special-defense"]} <progress class="stats" value="${pokemon.stats["special-defense"]}" max="100"></progress>
                </li>
                <li class="tableHeader">
                    Speed
                </li>
